...
export const Sidebar = () => {
  ...
  const forensicLinks = [
    ...
    { name: 'Role & Permissions', path: '/admin/roles', icon: Key, adminOnly: true },
  ];
  ...
  const activeCasesSummary = [
    { id: 'CASE-2026-001', name: 'Cyber Breach Dossier', tag: 'HIGH SEV', color: 'text-rose-400 bg-rose-500/10 border-rose-500/20' },
    { id: 'CASE-2026-002', name: 'Cryptographic Tamper', tag: 'CRITICAL', color: 'text-amber-400 bg-amber-500/10 border-amber-500/20' },
    { id: 'CASE-2026-003', name: 'Document Exfiltration', tag: 'ACTIVE', color: 'text-violet-400 bg-violet-500/10 border-violet-500/20' },
  ];
  ...
  return (
    <aside className="w-64 bg-[#0A0C14] border-r border-white/[0.06] flex flex-col justify-between p-4 flex-shrink-0 min-h-[calc(100vh-3.5rem)] select-none">
      <div className="space-y-4">
        ...
        {/* 4. Active Priority Dossiers Mini-List (matching "Active Staking (6)" in reference) */}
